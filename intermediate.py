...
parsed_content = ""
def text_to_audio(parsed_content):
    ...
    while i < n:
        ...
        if (flag == 0):
            ...
            if (content[i] != '\\' and content[i] != '^' and content[i] != '&'
                ...
                if(i>=n-1):
                    i+=1
                elif(content[i + 1] != '\\'):  # flag when you see \
                    '''
                    if (content[i + 1] == "\\n"):
                        print("error here")
                        i = i + 1
        ...
        if (flag == 1):
            if(content[i:i+3]=="sin"):
                ...
                flag=0
                i=i+4
            elif(content[i:i+3]=="cap"):
                parsed_content += " intersection "
                flag=0
                i=i+4
            elif(content[i:i+3]=="cup"):
                parsed_content += " union "
                flag=0
                i=i+4
            elif(content[i:i+6]=="subset"):
                parsed_content += " is subset of "
                flag=0
                i=i+7
            elif(content[i:i+2]=="in"):
                parsed_content += " belongs to "
                flag=0
                i=i+3
            elif(content[i:i+5]=="notin"):
                parsed_content += " does not belong to "
                flag=0
                i=i+6
            elif (content[i:i + 4] == "frac"):
                #print("i here is ",i)
                j = i + 5
                li = ['{']
                while (li):
            ...
            elif(content[i:i+5] == "ldots"):
                parsed_content += "so on "
                i+= 5
                flag = 0
                # print("here")
            else:
